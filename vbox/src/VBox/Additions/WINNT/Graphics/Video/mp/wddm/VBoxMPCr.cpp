/* $Id: VBoxMPCr.cpp 76553 2019-01-01 01:45:53Z vboxsync $ */
/** @file
...
#define VBOXMP_CRSHGSMICON_CMD_CMDBUF_OFFSET(_cBuffers) \
    VBOXWDDM_ROUNDBOUND(RT_UOFFSETOF_DYN(VBOXVDMACMD_CHROMIUM_CMD, aBuffers[_cBuffers]), 8)
...
#define VBOXMP_CRSHGSMICON_DR_CMDBUF_OFFSET(_cBuffers)  \
    VBOXWDDM_ROUNDBOUND((VBOXVDMACMD_SIZE_FROMBODYSIZE(RT_UOFFSETOF_DYN(VBOXVDMACMD_CHROMIUM_CMD, aBuffers[_cBuffers]))), 8)
