/* $Id: HWACCMR0.cpp 2814 2007-05-23 14:53:08Z vboxsync $ */
/** @file
...
#if HC_ARCH_BITS == 64
    uint64_t    u32Base =  Desc->Gen.u32BaseHigh3 << 32ULL | Desc->Gen.u8BaseHigh2 << 24ULL | Desc->Gen.u8BaseHigh1 << 16ULL | Desc->Gen.u16BaseLow;
