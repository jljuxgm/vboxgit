/* $Id: tstIEMCheckMc.cpp 72505 2018-06-11 12:05:40Z vboxsync $ */
/** @file
...
#define IEM_MC_IMPLICIT_AVX_AIMPL_ARGS() IEM_MC_ARG_CONST(PX86XSAVEAREA, pXState, pVCpu->cpum.GstCtx.CTX_SUFF(pXState), 0)
