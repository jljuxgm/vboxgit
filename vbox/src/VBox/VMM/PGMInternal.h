/* $Id: PGMInternal.h 23483 2009-10-01 13:40:25Z vboxsync $ */
/** @file
...
#define PGM_PAGE_WITH_U16MISCY 1
    ...
    /** Combination of:
     *  - u2HandlerVirtStateY - the virtual handler state
     *    (PGM_PAGE_HNDL_VIRT_STATE_*).
     *  - fWrittenToY - flag indicating that a write monitored page was written to
     *    when set.
     *  - 5 unused bits. */
    uint8_t     f8MiscY;
#endif
