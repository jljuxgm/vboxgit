/* $Id: PDMCritSect.cpp 25718 2010-01-11 13:32:51Z vboxsync $ */
/** @file
...
#else
        rc = RTLockValidatorRecExclCreate(&pCritSect->Core.pValidatorRec, NIL_RTLOCKVALCLASS, RTLOCKVAL_SUB_CLASS_NONE,
