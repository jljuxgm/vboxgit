; $Id: bs3-cmn-SwitchToRing1.asm 59949 2016-03-07 23:15:22Z vboxsync $
;; @file
...
%endif
        ...
        ; In protected mode: Check the CPL we're currently at skip syscall if ring-1 already.
        mov     ax, cs
        and     ax, 3
        cmp     ax, 1
        je      .return
