#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: bs3-cpu-generated-1-data.py 66114 2017-03-15 15:41:58Z vboxsync $
...
class Bs3CpuGenerated1Generator(object):
    ...
    def generateCode(self, oOut):
        ...
        asLines = [
            '/*',
            ' * Autogenerated by  $Id: bs3-cpu-generated-1-data.py 66114 2017-03-15 15:41:58Z vboxsync $ ',
            ' * Do not edit!',
            ' */',
            '',
            '/*',
