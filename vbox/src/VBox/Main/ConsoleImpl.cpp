/* $Id: ConsoleImpl.cpp 20521 2009-06-12 15:28:26Z vboxsync $ */
...
#   include <sys/types.h>
#   include <sys/wait.h>
#ifndef VBOX_DYNAMIC_NET_ATTACH
#   include <net/if.h>
...
#ifdef VBOX_DYNAMIC_NET_ATTACH
    memset(&meAttachmentType, 0, sizeof(meAttachmentType));
#endif /* VBOX_DYNAMIC_NET_ATTACH */
 ...
 * @param   uInstance       The PDM device instance.
 * @param   uLun            The PDM LUN number of the drive.
 * @param   aAttachmentType The attachment type.
 *
 * @note Locks this object for writing.
 */
