/* $Id: Global.cpp 39248 2011-11-09 12:29:53Z vboxsync $ */
/** @file
 *
...
const Global::OSType Global::sOSTypes[] =
{
    ...
    { "Windows", "Microsoft Windows", "Windows31",          "Windows 3.1",
      VBOXOSTYPE_Win31,           VBOXOSHINT_NONE | VBOXOSHINT_FLOPPY,
    ...
    { "Windows", "Microsoft Windows", "Windows8",           "Windows 8",
      VBOXOSTYPE_Win8,            VBOXOSHINT_NONE | VBOXOSHINT_HWVIRTEX | VBOXOSHINT_IOAPIC | VBOXOSHINT_USBTABLET | VBOXOSHINT_ACCEL3D,
    ...
    { "MacOS",   "Mac OS X",          "MacOS_64",           "Mac OS X (64 bit)",
      ...
      ChipsetType_ICH9, AudioControllerType_HDA  },
    { "Other",   "Other",             "DOS",                "DOS",
      VBOXOSTYPE_DOS,             VBOXOSHINT_NONE | VBOXOSHINT_FLOPPY | VBOXOSHINT_NOUSB,
