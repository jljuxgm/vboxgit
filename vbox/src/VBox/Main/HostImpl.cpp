/* $Id: HostImpl.cpp 25310 2009-12-10 17:06:44Z vboxsync $ */
/** @file
...
STDMETHODIMP Host::COMGETTER(USBDeviceFilters)(ComSafeArrayOut(IHostUSBDeviceFilter*, aUSBDeviceFilters))
{
    ...
    AutoMultiWriteLock2 alock(this->lockHandle(), &m->treeLock COMMA_LOCKVAL_SRC_POS);
...
HRESULT Host::saveSettings(settings::Host &data)
{
    ...
    AutoReadLock alock(&m->treeLock COMMA_LOCKVAL_SRC_POS);
...
HRESULT Host::addChild(HostUSBDeviceFilter *pChild)
{
    ...
    AutoWriteLock alock(&m->treeLock COMMA_LOCKVAL_SRC_POS);
