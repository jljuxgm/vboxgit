/* $Id: VBoxNetFlt-solaris.c 12620 2008-09-21 15:20:32Z vboxsync $ */
/** @file
...
static int VBoxNetFltSolarisModReadPut(queue_t *pQueue, mblk_t *pMsg)
{
    ...
    if (!pMsg || !pQueue)
    {
        LogRel((DEVICE_NAME ":VBoxNetFltSolarisModReadPut huh?? Invalid parameters.\n"));
        return 0;
    }
