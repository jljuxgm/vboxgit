; $Id: VBoxVgaBiosAlternative286.asm 76817 2019-01-14 14:38:15Z vboxsync $ 
;; @file
...
_msg_vga_init:                               ; 0xc4600 LB 0x2e
    db  'Oracle VM VirtualBox Version 6.0.2 VGA BIOS', 00dh, 00ah, 000h
...
_vbebios_product_revision:                   ; 0xc7caf LB 0x23
    db  'Oracle VM VirtualBox Version 6.0.2', 000h
