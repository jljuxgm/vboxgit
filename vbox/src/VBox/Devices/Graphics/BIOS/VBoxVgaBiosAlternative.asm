; $Id: VBoxVgaBiosAlternative.asm 48664 2013-09-24 20:26:56Z vboxsync $ 
;; @file
...
_msg_vga_init:                               ; 0xc4800 LB 0x34
    db  'Oracle VM VirtualBox Version 4.3.0_BETA3 VGA BIOS', 00dh, 00ah, 000h
...
_vbebios_product_revision:                   ; 0xc7e6f LB 0x29
    db  'Oracle VM VirtualBox Version 4.3.0_BETA3', 000h
