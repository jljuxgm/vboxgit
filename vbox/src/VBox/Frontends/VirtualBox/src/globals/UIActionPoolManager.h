/* $Id: UIActionPoolManager.h 85547 2020-07-30 09:14:00Z vboxsync $ */
/** @file
...
enum UIActionIndexST
{
    ...
    UIActionIndexST_M_Machine_M_MoveToGroup_S_New,
    ...
    UIActionIndexST_M_Machine_M_Console_S_CopyCommandSerialUnix,
    UIActionIndexST_M_Machine_M_Console_S_CopyCommandSerialWindows,
    UIActionIndexST_M_Machine_M_Console_S_CopyCommandVNCUnix,
    ...
    UIActionIndexST_M_VMResourceMonitor_S_SwitchToMachinePerformance,
